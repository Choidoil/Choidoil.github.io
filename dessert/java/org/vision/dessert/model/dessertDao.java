...
public interface dessertDao {
		...
		public List<dessert> selectAll() throws SQLException;//★
		// key에 해당하는 자료들을 골라 List에 담아 리턴 
		public List<dessert> selectKey(Integer key) throws SQLException;
		// key에 해당하는 하나의 자료를 vo로 리턴 
		public dessert selectVO(Integer key) throws SQLException;//★
		// 카테고리 별 
		public List<dessert> listByCategory(int category) throws SQLException;
		...
		//public List<dessert> selectPart(int start,int end)  
		//		throws SQLException;//★
		// 금방 생성된 시퀀스값을 얻어오기 
