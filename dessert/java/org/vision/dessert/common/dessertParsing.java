...
public class dessertParsing {
	public static dessert parsing(String target) throws Exception{
		//"0/SONATA/3/50000/4/현대/sonata.jpg/참좋은차다"
		String[] tokens = target.split("/");
		dessert car = new dessert();
		String errormsg="";
		try {
			car.setNo(0);
	...
	public static void main(String[] args) throws Exception {
		...
		dessert x = dessertParsing.parsing(target);
		...
		dessert y	 =(dessert)parser.parsing(target, setters);
