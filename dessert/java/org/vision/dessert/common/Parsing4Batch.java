...
public class Parsing4Batch {
	...
	public static void main(String[] args) throws Exception {
		Parsing4Batch parser = new Parsing4Batch(dessert.class, "/");
		String[] setters1 = new String[] { 
				"setName", "setCategory", "setPrice", "setUsepeople", "setCompany", "setImg",
				"setInfo" };
		dessert x = (dessert) parser.parsing("SONATA/3/50000/4/현대/sonata.jpg/참좋은차다", setters1);
		System.out.println(x);
		// ---------------------------------------------------------
		Parsing4Batch parser2 = new Parsing4Batch(dessertMember.class, "/");
		String[] setters2 = new String[] { "setId", "setPass", "setEmail", "setTel", "setAge", "setJob", "setHobby" };
		dessertMember mem = (dessertMember) parser2.parsing("sjw/1234/jaain@naver.com/010-2307-3558/60대/교수/등산", setters2);
