...
<br><br>
	...
	<table width="500" align="center" border="0">
		<tr>
			<th>회원아이디</th>
			<td><input type="text" name="id"  style="width:381px; height:40px"></td>
		</tr>
		
		<tr>
			<th>패스워드</th>
			<td><input type="password" name="pass"  style="width:381px; height:40px"></td>
		</tr>
		
		<tr>
			<th>이메일</th>
			<td><input type=email name="email"  style="width:381px; height:40px" ></td>
		</tr>
		
		
		<tr>
			<th>전화번호</th>
			<td><input type="text" name="tel"  style="width:381px; height:40px"></td>
		</tr>
		
		<tr>
					<th>생년월일</th>
					<td><input type=date name="age" style="width:381px; height:40px"></td>
		...
		<tr>
			<th>직업</th>
			<td><input type="text" name="job"  style="width:381px; height:40px"></td>
		</tr>
		
		<tr>
			<th>취미</th>
			<td><input type="text" name="hobby"  style="width:381px; height:40px"></td>
		</tr>
		...
		<tr>
			<td align='center' colspan="2">
				<p></p><input type="submit" value="가입하기">&nbsp;&nbsp;
