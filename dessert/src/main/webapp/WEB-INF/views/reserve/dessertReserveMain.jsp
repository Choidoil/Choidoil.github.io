...
<%@page import="org.vision.dessert.model.dessert"%>
<%@page import="java.util.List"%>
<%@page import="org.vision.dessert.model.dessertDao"%>
...
<c:forEach items="${recentList}" var="dto">
	...
	<table width="90%" align="center">
		...
		<tr height="240">
				...
				<td width="333" align="center"><a href="/dessert/reserve/reserve?no=${dto.no}"> <img
						alt="" src="../resources/${dto.img}" width="300" height="200">
				</a>
					<p>강의명 : ${dto.name}</td><br>
