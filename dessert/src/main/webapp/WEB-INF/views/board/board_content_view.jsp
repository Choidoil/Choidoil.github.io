...
<table class="boxx">
	<form action = "modify" method="post">
		<input type="hidden" name="num" value="${content.num}" style="width:381px; height:40px" readonly/ >
		
		<tr>
			<th>게시일자 </th>
			<td><input type="text"  size="50" value="${content.reg_date}" style="width:381px; height:40px" readonly/> </td>
		</tr>
		
		<tr>
			<th>조회수</th>
			<td><input type="text" size="50" value="${content.readcount}" style="width:381px; height:40px" readonly/ ></td>
		</tr>
		
		<tr>
			<th>게시자</th>
			<td><input type="text" name="writer" size="50" value="${content.writer}" style="width:381px; height:40px" readonly/ ></td>
		</tr>
		<tr>
			<th>이메일</th>
			<td><input type="text" name="email" size="50" value="${content.email}" style="width:381px; height:40px" readonly/ ></td>
		</tr>
		<tr>
			<th>*제목</th>
			<td><input type="text" name="subject" size="50" value="${content.subject }" style="width:381px; height:40px"></td>
		</tr>
		
		<tr>
			<th>*암호</th>
			<td><input type="password" name="password"  style="width:381px; height:40px; size:50;"></td>
		</tr>
		...
		<tr>
			<th>*내용</th>
			<td><textarea  name="content" rows="10" cols="49" style="width:381px; height:200px">${content.content}</textarea ></td>
		</tr>
		
		<tr>
		
			<td colspan="2"><input type="submit" value="수정"> &nbsp;&nbsp;
         <a href="delete?num=${content.num}">삭제</a>&nbsp;&nbsp;
         <a href="list">목록가기</a>  &nbsp;&nbsp; 
         <a href="reply_view?num=${content.num}">댓글</a>  </td>
		</tr>
