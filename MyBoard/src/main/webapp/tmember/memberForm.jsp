...
<header class="masthead bg-primary text-white text-right">
    <div class="container d-flex align-items-center flex-column">
		...
		<form method="post"   action="${contextPath}/member/addMember.do" class="masthead-avatar mb-5">
		<h1  style="text-align:center" >회원 가입창</h1>
		<table  style="text-align:right"  >
		    <tr>
		       <td nowrap width="100%" ><p align="center">아이디</td>
		       <td width="250"><input type="text" name="id"></td>
		    </tr>
		    <tr>
		        <td nowrap width="100%"><p align="center">비밀번호</td>
		        <td width="250"><input type="password"  name="pwd"></td>
		    </tr>
		    <tr>
		        <td width="100%"><p align="center">이름</td>
		        <td width="250"><p><input type="text"  name="name"></td>
		    </tr>
		    <tr>
		        <td width="100%"><p align="center">이메일</td>
		        <td width="250"><p><input type="text"  name="email"></td>
		    </tr>
		    <tr>
		        <td width="100"><p>&nbsp;</p></td>
		        <td width="250">
